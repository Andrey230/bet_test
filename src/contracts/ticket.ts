...
function initTicket_init_args(src: Ticket_init_args) {
    return (builder: Builder) => {
        ...
        let b_1 = new Builder();
        b_1.storeInt(src.ticket_amount, 257);
        b_1.storeInt(src.option, 257);
        b_1.storeRef(src.content);
        b_0.storeRef(b_1.endCell());
    };
}
...
async function Ticket_init(event_address: Address, owner_address: Address, index: bigint, ticket_amount: bigint, option: bigint, content: Cell) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initTicket_init_args({ $$type: 'Ticket_init_args', event_address, owner_address, index, ticket_amount, option, content })(builder);
...
const Ticket_getters: ABIGetter[] = [
    {"name":"get_ticket_content","arguments":[],"returnType":{"kind":"simple","type":"TicketData","optional":false}},
]
...
export class Ticket implements Contract {
    ...
    static async init(event_address: Address, owner_address: Address, index: bigint, ticket_amount: bigint, option: bigint, content: Cell) {
        return await Ticket_init(event_address, owner_address, index, ticket_amount, option, content);
    }

    static async fromInit(event_address: Address, owner_address: Address, index: bigint, ticket_amount: bigint, option: bigint, content: Cell) {
        const init = await Ticket_init(event_address, owner_address, index, ticket_amount, option, content);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: DeployTicket | ReturnTicket | CancelTicket | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'DeployTicket') {
            body = beginCell().store(storeDeployTicket(message)).endCell();
        }
    ...
    async getGetTicketContent(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('get_ticket_content', builder.build())).stack;
