...
export function storeCreateTicket(src: CreateTicket) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(1616666642, 32);
        b_0.storeUint(src.query_id, 64);
        b_0.storeUint(src.ticket_amount, 8);
...
export function loadCreateTicket(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1616666642) { throw Error('Invalid prefix'); }
    let _query_id = sc_0.loadUintBig(64);
    let _ticket_amount = sc_0.loadUintBig(8);
...
function initEvent_init_args(src: Event_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.event_creator_address);
        b_0.storeInt(src.index, 257);
    };
}

async function Event_init(event_creator_address: Address, index: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initEvent_init_args({ $$type: 'Event_init_args', event_creator_address, index })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const Event_errors: { [key: number]: { message: string } } = {
...
const Event_types: ABIType[] = [
    ...
    {"name":"CreateTicket","header":1616666642,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"ticket_amount","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"ticket_option","type":{"kind":"simple","type":"uint","optional":false,"format":8}}]},
...
const Event_getters: ABIGetter[] = [
    {"name":"get_event_data","arguments":[],"returnType":{"kind":"simple","type":"EventData","optional":false}},
    {"name":"get_options","arguments":[],"returnType":{"kind":"dict","key":"int","value":"int"}},
]

const Event_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"DeployEvent"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CreateTicket"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CancelEvent"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalReturnTicket"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalCancelTicket"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetWinnerOption"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalClearEvent"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class Event implements Contract {

    static async init(event_creator_address: Address, index: bigint) {
        return await Event_init(event_creator_address, index);
    }

    static async fromInit(event_creator_address: Address, index: bigint) {
        const init = await Event_init(event_creator_address, index);
        const address = contractAddress(0, init);
        return new Event(address, init);
    }
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: DeployEvent | CreateTicket | CancelEvent | InternalReturnTicket | InternalCancelTicket | SetWinnerOption | InternalClearEvent | Deploy) {

        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'DeployEvent') {
            body = beginCell().store(storeDeployEvent(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CreateTicket') {
            body = beginCell().store(storeCreateTicket(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CancelEvent') {
            body = beginCell().store(storeCancelEvent(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InternalReturnTicket') {
            body = beginCell().store(storeInternalReturnTicket(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InternalCancelTicket') {
            body = beginCell().store(storeInternalCancelTicket(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetWinnerOption') {
            body = beginCell().store(storeSetWinnerOption(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InternalClearEvent') {
            body = beginCell().store(storeInternalClearEvent(message)).endCell();
        }
    ...
    async getGetEventData(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('get_event_data', builder.build())).stack;
        const result = loadTupleEventData(source);
        return result;
    }

    async getGetOptions(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('get_options', builder.build())).stack;
