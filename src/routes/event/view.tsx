            ...
            <div className="">
                <div className="bg-base-100 rounded-xl shadow-xl">
                    <div className="bg-cover bg-center h-44 rounded-t-xl mt-3 relative" style={{backgroundImage: `url(${event.image})`}} >
                        ...
                        {event.is_completed ?
                            <div className="flex justify-start flex-nowrap gap-2 items-center flex-wrap overflow-scroll mt-3 absolute left-0 bottom-0 bg-base-content/80 p-1 px-2 rounded-xl mb-2 ml-2 max-w-44 overflow-hidden">
                                <div>
