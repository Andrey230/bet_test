        ...
        <div className="card bg-base-100 shadow-xl w-full">
            ...
            <div className="card-body  p-4">
                ...
                <div className="collapse bg-base-200 collapse-arrow mt-2">
                    <input type="checkbox" />
                    <div className="collapse-title text-xl font-medium flex justify-start items-center gap-2 bg-secondary-content/90">
                        ...
                        <span className="text-neutral">{t("profile.tickets")}</span>
                    </div>
                    <div className="collapse-content bg-secondary-content/90">
