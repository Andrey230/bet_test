    ...
    return (
        <div className="card bg-base-100 shadow-xl w-full">
            ...
            <div className="card-body  p-4">
                <Link to={"event/" + event.address}><h2 className="font-bold text-xl text-primary">{event.name}</h2></Link>
                ...
                <div className="collapse bg-base-200 collapse-arrow mt-2">
                    ...
                    <div className="collapse-title text-xl font-medium flex justify-start items-center gap-2">
                        {winnerTickets > 0 ? <span className="animate-bounce">
