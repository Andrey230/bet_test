            ...
            <div className="card bg-base-100 shadow-xl w-full">
                <div className="bg-cover bg-center h-44 rounded-t-xl" style={{backgroundImage: `url(${event.image})`}} >
                    <div className="bg-cover bg-center h-44 rounded-lg relative" style={{backgroundImage: `url(${event.image})`}} >
                        ...
                        {event.is_completed ?
                            <div className="mt-3 absolute left-0 bottom-0 bg-base-content/80 p-1 px-2 rounded-xl mb-2 ml-2 max-w-44">
                                <p className="text-nowrap overflow-scroll overflow-y-hidden">
                                    ...
                                    <span className="text-lg font-bold text-warning">{event.options[event.winner_option - 1].name.slice(0, 15)}</span>
                                </p>
                            </div>
                            : ""}
                    </div>
